...
<body>
    ...
    <div class="container header">
        ...
        <div class="row mt-5 shadow p-3 mb-1 bg-white rounded">
            <div class="col-md-3   ">
                <img src="https://cdn.ostad.app/public/upload/2023-10-17T07-14-50.690Z-Logo-new.png" alt="Ostad">
            </div>
            <div class="col-md-9">
                <ul class="nav nav-tabs">
                    <li class="nav-item ">
                        <a class="nav-link active mr-3" aria-current="page" href="#task1" data-toggle="tab">Task
                            1</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="card mt-3">
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="task1">
                    <p class="text-center p-3 bg-primary "> <b>Task 1</b> <br> <b>Note: </b>Write a SQL query
                        to retrieve
                        all the
                        customer information along with the total number of orders placed by each customer. Display the
                        result in descending order of the number of orders.</p>
                ...
                <div class="tab-pane fade" id="task2">
                    <p class="text-center p-3 bg-primary "> <b>Task 2</b> <br> <b>Note: </b>Write a SQL query
                        to retrieve the
                        product name, quantity, and total amount for each order item. Display the result in ascending
                        order of the order ID.</p>
                    <table class="table table-striped">
                        <thead>
                            <tr class='bg-dark text-white'>
                ...
                <div class="tab-pane fade" id="task3">
                    <p class="text-center p-3 bg-primary "> <b>Task 3</b> <br> <b>Note: </b>Write a SQL query
                        to retrieve the total
                        revenue generated by each product category. Display the category name along with the total
                        revenue in descending order of the revenue.</p>
                    <table class="table table-striped">
                        <thead>
                            <tr class='bg-dark text-white'>
                ...
                <div class="tab-pane fade" id="task4">
                    <p class="text-center p-3 bg-primary"> <b>Task 4</b> <br> <b>Note: </b>Write a SQL query
                        to retrieve the top 5
                        customers who have made the highest total purchase amount. Display the customer name along with
                        the total purchase amount in descending order of the purchase amount.</p>
                    <table class="table table-striped">
                        <thead>
                            <tr class='bg-dark text-white'>
